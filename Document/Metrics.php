...
class Metrics
{
    ...
    #[MongoDB\EmbedOne(targetDocument: DailyMetric::class)]
    protected $dailyMetric;

    #[JMS\Groups(['metrics'])]
    #[JMS\Type('rtPiwikBundle\Document\WeeklyMetric')]
    #[MongoDB\EmbedOne(targetDocument: WeeklyMetric::class)]
    ...
    #[MongoDB\EmbedOne(targetDocument: DailyPercentageChangeMetric::class)]
    protected $dailyPercentageChange;

    #[JMS\Groups(['metrics'])]
    #[JMS\Type('rtPiwikBundle\Document\WeeklyPercentageChangeMetric')]
    #[MongoDB\EmbedOne(targetDocument: WeeklyPercentageChangeMetric::class)]
